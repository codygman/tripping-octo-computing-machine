...
class Document b where
  title :: forall eff. b -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prim.String
  setTitle :: forall eff. Prim.String -> b -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prelude.Unit
  body :: forall eff. b -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Data.DOM.Simple.Types.HTMLElement
  setBody :: forall eff. Data.DOM.Simple.Types.HTMLElement -> b -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prelude.Unit
