...
class UIEventTarget b where
  addUIEventListener :: forall e t ta. (Data.DOM.Simple.Events.UIEvent e) => Data.DOM.Simple.Events.UIEventType -> (e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | t) Prelude.Unit) -> b -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | ta) Prelude.Unit
  removeUIEventListener :: forall e t ta. (Data.DOM.Simple.Events.UIEvent e) => Data.DOM.Simple.Events.UIEventType -> (e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | t) Prelude.Unit) -> b -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | ta) Prelude.Unit
class (Data.DOM.Simple.Events.Event e) <= UIEvent e where
  view :: forall eff. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Data.DOM.Simple.Types.HTMLWindow
  detail :: forall eff. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prim.Number
class KeyboardEventTarget b where
  addKeyboardEventListener :: forall e t ta. (Data.DOM.Simple.Events.KeyboardEvent e) => Data.DOM.Simple.Events.KeyboardEventType -> (e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | t) Prelude.Unit) -> b -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | ta) Prelude.Unit
  removeKeyboardEventListener :: forall e t ta. (Data.DOM.Simple.Events.KeyboardEvent e) => Data.DOM.Simple.Events.KeyboardEventType -> (e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | t) Prelude.Unit) -> b -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | ta) Prelude.Unit
class (Data.DOM.Simple.Events.Event e) <= KeyboardEvent e where
  keyboardEventType :: forall eff. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Data.DOM.Simple.Events.KeyboardEventType
  key :: forall eff. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prim.String
  keyCode :: forall eff. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prim.Number
  keyLocation :: forall eff. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Data.DOM.Simple.Events.KeyLocation
  altKey :: forall eff. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prim.Boolean
  ctrlKey :: forall eff. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prim.Boolean
  metaKey :: forall eff. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prim.Boolean
  shiftKey :: forall eff. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prim.Boolean
class MouseEventTarget b where
  addMouseEventListener :: forall e t ta. (Data.DOM.Simple.Events.MouseEvent e) => Data.DOM.Simple.Events.MouseEventType -> (e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | t) Prelude.Unit) -> b -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | ta) Prelude.Unit
  removeMouseEventListener :: forall e t ta. (Data.DOM.Simple.Events.MouseEvent e) => Data.DOM.Simple.Events.MouseEventType -> (e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | t) Prelude.Unit) -> b -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | ta) Prelude.Unit
class (Data.DOM.Simple.Events.Event e) <= MouseEvent e where
  mouseEventType :: forall eff. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Data.DOM.Simple.Events.MouseEventType
  screenX :: forall eff. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prim.Number
  screenY :: forall eff. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prim.Number
class Event e where
  eventTarget :: forall eff a. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) a
  stopPropagation :: forall eff. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prelude.Unit
  preventDefault :: forall eff. e -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prelude.Unit
class Read s where
  read :: Prim.String -> s
