...
var uiEventTypeShow = new Prelude.Show(function (_26) {
    if (_26 instanceof LoadEvent) {
        return "load";
    };
    if (_26 instanceof UnloadEvent) {
        return "unload";
    };
    if (_26 instanceof AbortEvent) {
        return "abort";
    };
    if (_26 instanceof ErrorEvent) {
        return "error";
    };
    if (_26 instanceof SelectEvent) {
        return "select";
    };
    if (_26 instanceof ResizeEvent) {
        return "resize";
    };
    if (_26 instanceof ScrollEvent) {
        return "scroll";
    };
    throw new Error("Failed pattern match");
});
var uiEventTypeRead = new Read(function (_27) {
    if (_27 === "load") {
...
var toKeyLocation = function (_21) {
    if (_21 === 0) {
...
var mouseEventTypeRead = new Read(function (_23) {
    if (_23 === "mousemove") {
...
var keyboardEventTypeShow = new Prelude.Show(function (_24) {
    if (_24 instanceof KeydownEvent) {
        return "keydown";
    };
    if (_24 instanceof KeypressEvent) {
        return "keypress";
    };
    if (_24 instanceof KeyupEvent) {
        return "keyup";
    };
    throw new Error("Failed pattern match");
});
var keyboardEventTypeRead = new Read(function (_25) {
    if (_25 === "keydown") {
