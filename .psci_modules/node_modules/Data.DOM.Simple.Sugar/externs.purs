...
class DOMArrows b where
  (#<-) :: forall eff. b -> Data.Tuple.Tuple Prim.String Prim.String -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prelude.Unit
  (<-#) :: forall eff. b -> Prim.String -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prim.String
  (<-?) :: forall eff. b -> Prim.String -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) (Data.Maybe.Maybe Data.DOM.Simple.Types.HTMLElement)
  (%<-) :: forall eff. b -> Prim.String -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prelude.Unit
  (@<-) :: forall eff. b -> Prim.String -> Control.Monad.Eff.Eff (dom :: Data.DOM.Simple.Types.DOM | eff) Prelude.Unit
