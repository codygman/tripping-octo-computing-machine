...
var arrowsMaybeHTMLElement = function (__dict_Element_0) {
    return new DOMArrows(function (_11) {
        return function (_12) {
            if (_11 instanceof Data_Maybe.Just) {
                return $hash$less$minus(arrowsMaybeHTMLElement(__dict_Element_0))(Data_Maybe.Just.create(_11.value0))(_12);
            };
        ...
        return function (_18) {
            if (_17 instanceof Data_Maybe.Just) {
                return $percent$less$minus(arrowsMaybeHTMLElement(__dict_Element_0))(Data_Maybe.Just.create(_17.value0))(_18);
            };
            throw new Error("Failed pattern match");
        };
    }, function (_13) {
        return function (_14) {
            if (_13 instanceof Data_Maybe.Just) {
                return $less$minus$hash(arrowsMaybeHTMLElement(__dict_Element_0))(Data_Maybe.Just.create(_13.value0))(_14);
            };
            throw new Error("Failed pattern match");
        };
    }, function (_15) {
        return function (_16) {
            if (_15 instanceof Data_Maybe.Just) {
                return $less$minus$qmark(arrowsMaybeHTMLElement(__dict_Element_0))(Data_Maybe.Just.create(_15.value0))(_16);
            };
            throw new Error("Failed pattern match");
        };
    }, function (_19) {
        return function (_20) {
            if (_19 instanceof Data_Maybe.Just) {
                return $at$less$minus(arrowsMaybeHTMLElement(__dict_Element_0))(Data_Maybe.Just.create(_19.value0))(_20);
            };
            throw new Error("Failed pattern match");
        };
    });
