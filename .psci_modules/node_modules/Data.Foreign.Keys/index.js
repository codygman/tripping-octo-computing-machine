...
var keys = function (_107) {
    ...
    if (Data_Foreign.isUndefined(_107)) {
        return Data_Either.Left.create(new Data_Foreign.TypeMismatch("object", "undefined"));
    };
    if (Data_Foreign.typeOf(_107) === "object") {
        return Data_Either.Right.create(unsafeKeys(_107));
    };
    return Data_Either.Left.create(new Data_Foreign.TypeMismatch("object", Data_Foreign.typeOf(_107)));
};
module.exports = {
    keys: keys
};
