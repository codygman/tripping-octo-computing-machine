...
var singleton = function (k) {
    return function (v) {
        return pureST(function __do() {
            var _5 = Data_StrMap_ST["new"]();
            Data_StrMap_ST.poke(_5)(k)(v)();
            return _5;
        });
    };
};
...
var fromList = function (l) {
    return pureST(function __do() {
        ...
        Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(l)(function (_72) {
            return Data_StrMap_ST.poke(_6)(_72.value0)(_72.value1);
        })();
        return _6;
    });
};
