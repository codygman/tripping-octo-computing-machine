...
var $less = function (__dict_Ord_11) {
    return function (a1) {
        return function (a2) {
            var _278 = compare(__dict_Ord_11)(a1)(a2);
            if (_278 instanceof LT) {
                return true;
            };
            return false;
        };
...
var $less$eq = function (__dict_Ord_12) {
    return function (a1) {
        return function (a2) {
            var _279 = compare(__dict_Ord_12)(a1)(a2);
...
var $greater = function (__dict_Ord_13) {
    return function (a1) {
        return function (a2) {
            var _280 = compare(__dict_Ord_13)(a1)(a2);
            if (_280 instanceof GT) {
                return true;
            };
            return false;
        };
...
var $greater$eq = function (__dict_Ord_14) {
    return function (a1) {
        return function (a2) {
            var _281 = compare(__dict_Ord_14)(a1)(a2);
...
var ordArray = function (__dict_Ord_10) {
    return new Ord(function () {
        ...
        return function (_24) {
            ...
            if (_23.length >= 1) {
                var _288 = _23.slice(1);
                if (_24.length >= 1) {
                    var _286 = _24.slice(1);
                    var _284 = compare(__dict_Ord_10)(_23[0])(_24[0]);
                    if (_284 instanceof EQ) {
                        return compare(ordArray(__dict_Ord_10))(_288)(_286);
                    };
                    return _284;
                };
            };
